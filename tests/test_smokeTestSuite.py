...
class TestSmokeTestSuite():
  ...
  def test_joinPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Teddy")
    self.driver.find_element(By.NAME, "lname").send_keys("Rosevelt")
    self.driver.find_element(By.CSS_SELECTOR, ".myinput:nth-child(2)").click()
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("The man")
  ...
  def test_adminTestPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("mtg191")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("somethingexpressive")
